...
<div class="consulta-divs">
    ...
    echo "<tbody>";
                ...
                if(isset($con9)){ 
                    ...
                    foreach($con9 as $dato) {
                        echo "<tr>
                        <td data-label='Cantidad de pedidos'>".$dato["pedentregados"]."</td>
                        <td data-label='Nombre del repartidor'>".$dato["nombre"]."</td>
                        </tr></tbody>";
                    }

                
                }else{
                    echo '<tr><td class="alerta" colspan="2">No se seleccionó mes/Ningun repartidor entregó un pedido en ese mes.</td></tr>';
                }
