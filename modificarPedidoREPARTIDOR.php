...
<body>
    ...
    <div class="cuerpo">
        <h2 class="title-product">Pedido a entregar</h2>
...
<?php $num=$_GET['Numero']; ?>
    ...
    <form action="../Controlador/controladorRegistrarUsuario.php" method="POST" class="form-productos">
            <div class="contenedor-flex">
                ...
                <input type="text" name="numero" maxlength="30" placeholder="Número de pedido"value=<?php echo $num; ?>>
                </div></div>
                <div class="derecha">
                    <div class="derecha-divs">
                    <input type="text" name="destinatario" maxlength="30" placeholder="Destinatario">
                    </div>
                    </div>
